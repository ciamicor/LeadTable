...
async function createAttendee_Service(attendee: any, client: any, year: any, upload: any = null) {
  ...
  const data = {
    ...
    contact_Email: typeof undefined ? '' : attendee.contact_Email.toLowerCase().trim(),
    contact_Phone: typeof undefined ? '' : attendee.contact_Phone.trim(),
    contact_Employer: typeof undefined ? '' : attendee.contact_Employer.trim(),
    address_Line1: typeof undefined ? '' : attendee.address_Line1.trim(),
    address_Line2: typeof undefined ? '' : attendee.address_Line2.trim(),
    address_City: typeof undefined ? '' : attendee.address_City.trim(),
    address_State: typeof undefined ? '' : attendee.address_State.trim(),
    address_Zip: typeof undefined ? '' : attendee.address_Zip.trim(),
    address_Country: attendee.address_Country,
    title: typeof undefined ? '' : attendee.title.trim(),
    reg_Type: typeof undefined ? '' : attendee.reg_Type,
    tech_Sem: typeof undefined ? '' : attendee.tech_Sem,
    upload_Id: upload
  }
  console.log(data)
  try {
